...
function Intro() {
  ...
  return (
    <div className="bg-background flex min-h-[95dvh] flex-col items-center justify-center ">
      <div className="flex flex-1 w-full">
        <div className="grid grid-rows-[auto_1fr_auto] gap-4 lg:gap-6 items-center w-full">
          ...
          <main className=" items-center md:space-y-16 space-y-8 w-full">
            <div
              className="container prose prose-scale"
              dangerouslySetInnerHTML={{ __html: data.intro.html }}
            />
            <div className="transition-opacity fade-in">
              <LogoMarquee />
            </div>
          </main>
